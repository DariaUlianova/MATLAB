...
% Last Modified by GUIDE v2.5 28-May-2020 12:33:29
...
a3=get(handles.edit6,'string');
a4=str2double(a1)+str2double(a2)+str2double(a3);
set(handles.text11,'string' ,a4);
if a4>=250
    set(handles.text10,'string' ,'Поздравляем!');
else
     set(handles.text10,'string' ,'К сожалению, Вы не прошли');
end;
